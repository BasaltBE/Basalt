...
public sealed class ItemStackRequestCraftNonImplementedDeprecatedAction : ItemStackRequestActionVariant {
    ...
    public void Read(BinaryReader reader) {
        ...
        if (constValue0 != global::BedrockProtocol.Enums.ItemStackRequestActionType.CraftNonImplemented) {
            throw new FormatException($"Expected craftnonimplemented for ActionType, got {constValue0}.");
        }
    }

    public void Write(BinaryWriter writer) {
        writer.WriteUInt8((byte)(byte)global::BedrockProtocol.Enums.ItemStackRequestActionType.CraftNonImplemented);
    }
}
